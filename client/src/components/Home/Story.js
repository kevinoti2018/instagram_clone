...
const Story = () => {
  return (
    ...
    <div className="story_l">
        <button className='storybtn' >
            <img className="story_image" src="https://i.imgur.com/LBRXhIq.jpg" alt="pinky" srcSet="" />
            <p className="story_H" >Pinky</p>
        </button>
    </div>
    <div className="story_l">
        <button className='storybtn' >
            <img className="story_image" src="https://i.imgur.com/ARMxyC4.png" alt="jaon" srcSet="" />
            <p className="story_H" >Jason</p>
        </button>
    </div>
